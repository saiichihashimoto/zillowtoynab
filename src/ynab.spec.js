			...
			request.mockImplementation(() => Promise.resolve({
				data: {
					...
					transaction:     {
						...
						memo:                    'https://www.zillow.com/homedetails/9999999_zpid/#home-details-home-values',
						cleared:                 'cleared',
						approved:                true,
						flag_color:              null,
						...
						import_id:               'szestimate:ZPID:2018-01-02',
						deleted:                 false,
						subtransactions:         [],
					},
					server_knowledge: 7,
			...
			expect(request).toHaveBeenCalledWith({
				...
				body: {
					transaction: {
						...
						amount:     (1000000 - 1000) * 1000,
						payee_name: 'Zestimate® Adjustment',
						memo:       'https://www.zillow.com/homedetails/ZPID_zpid/#home-details-home-values',
						cleared:    'cleared',
						approved:   true,
						import_id:  'szestimate:ZPID:2018-01-02',
					},
